package com.sydney.actiondriver;
...
import com.sydney.actionInterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	@Override
	public boolean findElements(WebDriver driver, List<WebElement> elements) {
	    boolean flag = false;
	    try {
	        ...
	        if (flag) {
	            System.out.println("Successfully found all elements.");
	        } else {
	            System.out.println("Unable to locate one or more elements.");
	        }
	    }
		return flag;
	}
